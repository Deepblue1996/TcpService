...
public class AesUtil {
     ...
     * 密钥
     */
    private static final String KEY = "DeepBlueWork2020";// AES加密要求key必须要128个比特位（这里需要长度为16，否则会报错）
    ...
    public static void main(String[] args) throws Exception {
        String content = "url：findNames.action Date:" + System.currentTimeMillis();
